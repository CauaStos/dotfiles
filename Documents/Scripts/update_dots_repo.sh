...
include=(--include 'hypr/' --include 'macchina/' --include 'macchina/themes/' --include 'qt5ct/' --include 'qt5ct/colors/' --include 'qt6ct/' --include 'qt6ct/colors/' --include 'hyprpanel/' --include 'zed/' --include 'matugen/' --include 'matugen/templates/' --exclude '*/')
