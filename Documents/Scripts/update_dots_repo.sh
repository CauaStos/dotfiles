...
include=(--include 'hypr/' --include 'foot/' --include 'macchina/' --include 'macchina/themes/' --include 'qt5ct/' --include 'qt5ct/colors/' --include 'qt6ct/' --include 'qt6ct/colors/' --include 'hyprlauncher/' --include 'nwg-dock-hyprland/' --exclude '*/')
