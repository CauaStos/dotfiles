...
include=(--include 'hypr/' --include 'ghostty/' --include 'macchina/' --include 'macchina/themes/' --include 'qt5ct/' --include 'qt5ct/colors/' --include 'qt6ct/' --include 'qt6ct/colors/' --include 'nwg-dock-hyprland/' --include 'hyprpanel/' --include 'zed/' --include 'albert/' --exclude '*/')
